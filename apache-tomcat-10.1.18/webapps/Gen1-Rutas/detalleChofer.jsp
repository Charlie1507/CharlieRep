...
<body>
    ...
    <div class="container">
        ...
        <tbody>
            <tr>
                <td><a href="<%=request.getContextPath()%>/choferes/listar" class="btn btn-success">Volver</a></td>
                <td><a href="<%=request.getContextPath()%>/choferes/editar?id=<%=chofer.getId()%>" class="btn btn-primary">Editar</a></td>
                <td><a href="<%=request.getContextPath()%>/choferes/eliminar?id=<%=chofer.getId()%>" class="btn btn-danger">Eliminar</a></td>
            </tr>
        </tbody>
