...
<%@page import="com.silva.app.rutas.models.enums.*"%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipoCamion" id="tipoCamion" class="form-control">
                            ...
                            <option value="<%=camion.getTipoCamion() !=null ? camion.getTipoCamion(): ""%>"><%=camion.getTipoCamion() !=null ? camion.getTipoCamion(): ""%></option>
                            <%
                    ...
                    <div class="form-group">
                        ...
                        <option disabled="disabled">---Seleccione---</option>
                        <option selected="true" value="<%=camion.getModelo() !=null ? camion.getModelo(): ""%>"><%=camion.getModelo() !=null ? camion.getModelo(): ""%></option>
                        <%
                            for (String n : annios) {
                        %>
                    ...
                    <div class="form-group">
                        ...
                        <select name="marca" id="marca" class="form-control">
                            <option disabled="disabled">---Seleccione---</option>
                            <option selected="true" value="<%=camion.getMarca() !=null ? camion.getMarca(): ""%>"><%=camion.getMarca() !=null ? camion.getMarca(): ""%></option>
                            <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="capacidad" id="capacidad" class="form-control" value="<%=camion.getCapaciad() !=null ? camion.getCapaciad(): ""%>">
                        <%
