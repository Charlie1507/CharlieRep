...
<body>
    ...
    <div class="container">
        ...
        <a href="<%=request.getContextPath()%>/inquilinos/alta" class="btn btn-success">Alta Inquilino</a><br>
        <br>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <% for(Inquilino c: inquilinos) { %>
                    <tr>
                        ...
                        <td><a href="<%=request.getContextPath()%>/inquilinos/detalle?id=<%=c.getId()%>" class="btn-success">Detalle</a></td>
                        <td><a href="<%=request.getContextPath()%>/inquilinos/editar?id=<%=c.getId()%>" class="btn-primary">Editar</a></td>
                        <td><a href="<%=request.getContextPath()%>/inquilinos/eliminar?id=<%=c.getId()%>" class="btn-danger">Eliminar</a></td>
                    </tr>
                <% } %>
            </tbody>
        </table>
