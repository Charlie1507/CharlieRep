...
<%
  ...
  Boolean estado = mantenimiento.getEstadoFinalizado();
  String finalizado = estado == true ? "Finalizado" : "No finalizado";
  String fecha = mantenimiento.getFechaReporte() != null ? mantenimiento.getFechaReporte()
...
<body>
    ...
    <div class="container">
            ...
            <div class="col-12">
                <div class="card border">
                    <div class="card-header bg-primary text-white">
                        <h1><strong>Detalle del mantenimiento</strong></h1>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td><%= propiedad != null ? propiedad.getDireccion() : "No disponible" %></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th scope="row">Estado de finalizacion</th>
                                    <td><%=finalizado %></td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <div class="row mt-3">
            <div class="col-sm-4">
                <br>
                <a href="<%=request.getContextPath()%>/mantenimientos/listar" class="btn btn-success btn-block">Volver</a><br>
            </div>

            <div class="col-sm-4">
            <br>
                <a href="<%=request.getContextPath()%>/mantenimientos/eliminar?id=<%=mantenimiento.getId()%>" class="btn btn-danger btn-block">Eliminar</a><br>
            </div>
        </div>
    </div>
