...
<body>
    ...
    <div class="container">
        ...
        <a href="<%=request.getContextPath()%>/mantenimientos/alta" class="btn btn-success">Alta Mantenimiento</a><br>
        <br>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <% for(Mantenimiento c: mantenimientos) { %>
                    <tr>
                        <td><%=c.getId()%></td>
                        <td><td><%=c.getDireccionPropiedad()%></td></td>
                        <td><%=c.getFechaReporte()%></td>
                        <td><a href="<%=request.getContextPath()%>/mantenimientos/detalle?id=<%=c.getId()%>" class="btn-success">Detalle</a></td>
                        <td><a href="<%=request.getContextPath()%>/mantenimientos/eliminar?id=<%=c.getId()%>" class="btn-danger">Eliminar</a></td>
                    </tr>
                <% } %>
            </tbody>
        </table>
