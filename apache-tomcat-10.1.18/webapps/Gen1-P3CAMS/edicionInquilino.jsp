...
<%
  ...
  Inquilino inquilino =  (Inquilino) request.getAttribute("inquilino");
%>
    ...
    <nav>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <br>
                <a href="<%=request.getContextPath()%>/mantenimieintos/alta">Dar de alta </a> <br>
                <br>
            </div>
        </div>
        ...
        <div class="col-md-8 offset-md-2">
            <form action="<%=request.getContextPath()%>/inquilinos/editar" method="post" class="mt-4">
                <input type="hidden" name="id" value="<%=inquilino.getId()%>">
                <table class="table">
                    <tr>
                        <td><label for="nombre" class="form-label text-white">Nombre</label></td>
                        <td>
                            <input type="text" name="nombre" id="nombre" class="form-control" value="<%=inquilino.getNombre() !=null ? inquilino.getNombre(): ""%>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="apPaterno" id="apPaterno" class="form-control" value="<%=inquilino.getApPaterno() !=null ? inquilino.getApPaterno(): ""%>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="apMaterno" id="apMaterno" class="form-control" value="<%=inquilino.getApMaterno() !=null ? inquilino.getApMaterno(): ""%>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="telefono" id="telefono" class="form-control" value="<%=inquilino.getTelefono() !=null ? inquilino.getTelefono(): ""%>">
                    ...
                    <tr>
                        <td><label for="cuenta" class="form-label text-white">Fecha de pago</label></td>
                        <td>
                            <input type="text" name="fechaPago" id="fechaPago" class="form-control" value="<%=inquilino.getFechaPago() !=null ? inquilino.getFechaPago(): ""%>">
                            <% if (errores != null && errores.containsKey("fechaPago")) { %>
                                <span class='text-danger'><%= errores.get("fechaPago") %></span>
                            <% } %>
                        </td>
                    </tr>
                </table>
