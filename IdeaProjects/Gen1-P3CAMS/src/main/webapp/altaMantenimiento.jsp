...
<nav>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <h1 class="mb-4">Formulario Alta Mantenimiento</h1>
            </div>
        </div>
        ...
        <% } %>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <form action="<%=request.getContextPath()%>/mantenimientos/alta" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="descripcion" id="descripcion" class="form-control" value="${param.descripcion}"></textarea>
                        ...
                        <div class="mb-3">
                            <label for="fechaReporte" class="form-label text-white">Fecha del reporte</label>
                            <input type="date" name="fechaReporte" id="fechaReporte" class="form-control" value="${param.fechaReporte}">
                            <% if (errores != null && errores.containsKey("fechaReporte")) { %>
                                <span class='text-danger'><%= errores.get("fechaReporte") %></span>
                            <% } %>
                        </div>

                        <div class="mb-3">
                            <label for="costo" class="form-label text-white">Costo</label>
                            <input type="text" name="costo" id="costo" class="form-control" value="${param.costo}">
                            <% if (errores != null && errores.containsKey("costo")) { %>
                                <span class='text-danger'><%= errores.get("costo") %></span>
                            <% } %>
                        </div>

                        <div class="mb-3">
                            <label for="" class="form-label text-white">Estado finalizado</label>
                            <input type="checkbox" name="finalizado" id="finalizado" class="form-check-input" value="${param.finalizado}" checked>
                        </div>
