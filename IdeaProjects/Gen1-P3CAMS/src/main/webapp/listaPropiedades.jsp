...
<body>
    ...
    <div class="container">
        ...
        <a href="<%=request.getContextPath()%>/propiedades/alta" class="btn btn-success">Alta Propiedad</a><br>
        <br>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <% for(Propiedad c: propiedades) { %>
                    <tr>
                        ...
                        <td><%=c.getTipoPropiedad()%></td>
                        <td>$ <%=c.getPrecio()%> MXN</td>
                        <td><a href="<%=request.getContextPath()%>/propiedades/detalle?id=<%=c.getId()%>" class="btn-success">Detalle</a></td>
                        <td><a href="<%=request.getContextPath()%>/propiedades/editar?id=<%=c.getId()%>" class="btn-primary">Editar</a></td>
                        <td><a href="<%=request.getContextPath()%>/propiedades/eliminar?id=<%=c.getId()%>" class="btn-danger">Eliminar</a></td>
                    </tr>
                <% } %>
            </tbody>
        </table>
