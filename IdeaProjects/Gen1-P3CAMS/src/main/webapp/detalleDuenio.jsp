...
<body>
    ...
    <div class="container">
            ...
            <div class="col-12">
                <div class="card border">
                    <div class="card-header bg-primary text-white">
                        <h1><strong>Detalle del Dueño</strong></h1>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=duenio.getApPaterno() %></td>
                                </tr>
                                <tr>
                                    <th scope="row">Ap. Materno</th>
                                    <td><%=duenio.getApMaterno() %></td>
                                </tr>
                                <tr>
        ...
        <div class="row mt-3">
            <div class="col-sm-4">
                <br>
                <a href="<%=request.getContextPath()%>/duenios/listar" class="btn btn-success btn-block">Volver</a><br>
            </div>
            <div class="col-sm-4">
            <br>
                <a href="<%=request.getContextPath()%>/duenios/editar?id=<%=duenio.getId()%>" class="btn btn-primary btn-block">Editar</a><br>
            </div>
            <div class="col-sm-4">
            <br>
                <a href="<%=request.getContextPath()%>/duenios/eliminar?id=<%=duenio.getId()%>" class="btn btn-danger btn-block">Eliminar</a><br>
            </div>
        </div>
    </div>
