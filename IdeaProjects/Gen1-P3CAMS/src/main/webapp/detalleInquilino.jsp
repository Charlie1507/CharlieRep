...
<body>
    ...
    <div class="container">
            ...
            <div class="col-12">
                <div class="card border">
                    <div class="card-header bg-primary text-white">
                        <h1><strong>Detalle del inquilino</strong></h1>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=inquilino.getApPaterno() %></td>
                                </tr>
                                <tr>
                                    <th scope="row">Ap. Materno</th>
                                    <td><%=inquilino.getApMaterno() %></td>
                                </tr>
                                <tr>
                                    <th scope="row">Telefono</th>
                                    <td><%=inquilino.getTelefono() %></td>
                                </tr>
                                <tr>
                                    <th scope="row">Fecha de pago</th>
                                    <td><%=inquilino.getFechaPago() %></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="row mt-3">
            <div class="col-sm-4">
                <br>
                <a href="<%=request.getContextPath()%>/inquilinos/listar" class="btn btn-success btn-block">Volver</a><br>
            </div>
            <div class="col-sm-4">
            <br>
                <a href="<%=request.getContextPath()%>/inquilinos/editar?id=<%=inquilino.getId()%>" class="btn btn-primary btn-block">Editar</a><br>
            </div>
            <div class="col-sm-4">
            <br>
                <a href="<%=request.getContextPath()%>/inquilinos/eliminar?id=<%=inquilino.getId()%>" class="btn btn-danger btn-block">Eliminar</a><br>
            </div>
        </div>
    </div>
