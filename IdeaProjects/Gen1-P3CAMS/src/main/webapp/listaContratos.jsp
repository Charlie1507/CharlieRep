...
<%
  List<Contrato> contratos =  (List<Contrato>) request.getAttribute("contratos");
...
<body>
    ...
    <div class="container">
        ...
        <a href="<%=request.getContextPath()%>/contratos/alta" class="btn btn-success">Alta contratos</a><br>
        <br>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <% for(Contrato c: contratos) { %>
                    <tr>
                        <td><%=c.getId()%></td>
                        <td><%=c.getDireccionPropiedad()%></td>
                        <td><%=c.getNombreInquilino()%></td>
                        <td><a href="<%=request.getContextPath()%>/contratos/detalle?id=<%=c.getId()%>" class="btn-success">Detalle</a></td>
                    </tr>
                <% } %>
            </tbody>
        </table>
