...
<nav>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <h1 class="mb-4">Formulario Alta Inquilino</h1>
            </div>
        </div>
        ...
        <% } %>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <form action="<%=request.getContextPath()%>/inquilinos/alta" method="post">
                        ...
                        <div class="mb-3">
                            <label for="fechaPago" class="form-label text-white">Fechas de pago</label>
                            <input type="text" name="fechaPago" id="fechaPago" class="form-control" value="${param.fechaPago}">
