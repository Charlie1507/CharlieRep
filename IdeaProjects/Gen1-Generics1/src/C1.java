...
public class C1
{
    public static void main(String[] args)
    {
        ...
        IAppleCargador cargadorAL = new CargadorNormalApple();
        IAppleCargador cargadorAC = new CargadorCompactoApple();

        ISamsungCargador cargadorSL = new CargadorNormalSamsung();
        ISamsungCargador cargadorSR = new CargadorRapidoSamsung();
        ISamsungCargador cargaorSI = new CargadorInduccionSamsung();

        IXiaomiCargador cargadorXL = new CargadorNormalXiaomi();
        IXiaomiCargador cargadorXR = new CargadorRapidoXiaomi();
