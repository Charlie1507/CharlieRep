    ...
    <div class="container">
            ...
            <div class="cal-12">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Capacidad: </strong><%=camion.getCapaciad() %></li>
        ...
        <tbody>
            <tr>
                <br>
                <br>
                <td><a href="<%=request.getContextPath()%>/camiones/listar" class="btn btn-success">Volver</a></td><br>
                <br>
                <td><a href="<%=request.getContextPath()%>/camiones/editar?id=<%=camion.getId()%>" class="btn btn-primary">Editar</a></td><br>
                <br>
                <td><a href="<%=request.getContextPath()%>/camiones/eliminar?id=<%=camion.getId()%>" class="btn btn-danger">Eliminar</a></td><br>
            </tr>
        </tbody>
