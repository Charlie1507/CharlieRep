...
public class RutasRepository implements IRutasRepository
{
    ...
    public Long guardarReturnId(Ruta ruta) throws SQLException {
        String sql="";
        long resultado=-1L;
        sql = "insert into rutas (ID_RUTA, camion_id, chofer_id, direccion_origen_id, direccion_destino_id, distancia, fecha_salida, fecha_llegada_estimada, fecha_llegada_real,a_tiempo)" +
