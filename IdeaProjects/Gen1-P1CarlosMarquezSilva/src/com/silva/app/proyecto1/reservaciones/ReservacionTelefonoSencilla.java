...
public class ReservacionTelefonoSencilla implements IReservacion<HabitacionSencilla>
{
    @Override
    public void reservarHabitacion(HabitacionSencilla habitacion)
    {
        System.out.println("Estoy reservando en linea para una habitacion Sencilla para el mes " + habitacion.getMesReserva() +
