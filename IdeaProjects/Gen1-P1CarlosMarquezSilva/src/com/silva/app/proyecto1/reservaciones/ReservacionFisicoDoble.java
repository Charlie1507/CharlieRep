...
public class ReservacionFisicoDoble implements IReservacion<HabitacionDoble>
{
    @Override
    public void reservarHabitacion(HabitacionDoble habitacion)
    {
        System.out.println("Estoy reservando en fisico para una habitacion doble para el mes " + habitacion.getMesReserva() +
